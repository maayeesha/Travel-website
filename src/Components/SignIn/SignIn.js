...
const SignIn = (props) => {
  let baton;
    ...
    const style = {
      ...
      <p>Have an account? <span onClick={() => setHasAccount(!hasAccount)}>Book a tour!</span></p>
      </>
      }

    return (
            <div className='d-flex justify-content-center text-warning fw-bold' style={style} >
      <div>
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="email" autoFocus required value={email} onChange={e => setEmail(e.target.value)} placeholder="Enter email" />
      ...
      <Form.Group className="mb-3" controlId="">
        ...
        <Dropdown>
      <Dropdown.Toggle variant="success" id="dropdown-basic" className="fw-bold">
        Choose a place
      </Dropdown.Toggle>
