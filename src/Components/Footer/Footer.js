  ...
  return (
    ...
    <CDBBox display="flex" flex="column" className="mx-auto py-5" style={{ width: '90%' }}>
      <CDBBox display="flex" justifyContent="between" className="flex-wrap">
        <CDBBox>
          <a href="/" className="d-flex align-items-center p-0 text-dark" style={{backgroundColor: '#ffc3b1', borderRadius:'50px'}}>
            <img alt="logo" src={logo} width="120px" />
          </a>
          <p className="my-3" style={{ width: '250px' }}>
            We are providing the best travel experiences for people around the globe.
          </p>
      ...
      <small className="text-center mt-5"> Roam, 2022. All rights reserved.</small>
    </CDBBox>
  </CDBFooter>
  );
};
