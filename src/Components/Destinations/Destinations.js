...
const Destinations = () => {
    ...
    return (
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption style={fontStyle}>
          <h3>Paris, France</h3>
          <p>
          Also known as the Latin Quarter, the 5th arrondissement is home to the Sorbonne university and student-filled cafes. It's also known for its bookshops, including the famed Shakespeare and Company.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
    </Carousel>
      ...
      <Card.Body>
        <Card.Title className="fw-bold" style={{color:'teal',fontStyle: 'italic'}}>Australia</Card.Title>
        <Card.Text>
        Australia, officially the Commonwealth of Australia, is a sovereign country comprising the mainland of the Australian continent, the island of Tasmania, and numerous smaller islands.
        </Card.Text>
        <Button variant="success" className='fw-bold'>Book a tour</Button>
      </Card.Body>
    </Card>
    <Card style={cardStyle} >
      <Card.Img className="p-2" variant="top" src={japan} />
      <Card.Body>
        <Card.Title className="fw-bold" style={{color:'teal',fontStyle: 'italic'}}>Japan</Card.Title>
        <Card.Text>
    ...
    <Card style={cardStyle} >
      ...
      <Card.Body>
        <Card.Title className="fw-bold" style={{color:'teal',fontStyle: 'italic'}}>Switzerland</Card.Title>
        <Card.Text>
